...
export const ERROR_MESSAGES = {
  ...
  MASS_ID_DOCUMENT_NOT_FOUND: `The "${DocumentCategory.MassID}" document was not found.`,
  METHODOLOGY_DOCUMENT_NOT_FOUND: `The "${DocumentCategory.Methodology}" document was not found.`,
  ...
  UNEXPECTED_DOCUMENT_SUBTYPE: (subtype: string) =>
    `The "${DocumentCategory.MassID}" document has an unexpected subtype: ${subtype}.`,
} as const;
