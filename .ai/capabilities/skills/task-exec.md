...
when_to_use:
  - When given an implementation task to execute
  - When executing a plan autonomously
  - When asked to make changes across the codebase
workflow:
  - Read and understand the task requirements
  - Identify affected files and Nx projects
...
outputs:
  - Implemented changes passing all quality checks
