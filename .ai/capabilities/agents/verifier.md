...
id: verifier
name: Verifier
purpose: Quality gate agent that validates code changes pass all project checks before completion
when_to_delegate:
...
report_format: 'Pass/fail summary with error details for any failures'
tool_limits:
