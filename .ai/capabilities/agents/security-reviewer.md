...
purpose: Security specialist for AWS Lambda, secrets handling, input validation, and sensitive data in rule processors
when_to_delegate:
...
report_format: 'Security review grouped by severity: critical, high, medium, passed checks'
tool_limits:
