<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Mass Validation Document</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check if all mass validation documents that make up the certificate are linked to the BOLD methodology.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/mass-validation-document.processor.ts)**
