<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Mass Recycler Actor</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Verify if the participant declared as Recycler is the same in all masses, as requested by the methodology.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/mass-recycler-actor.processor.ts)**
