<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Mass Validation Document Status</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Verify if all mass validation documents that make up the certificate have an approved status.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/mass-validation-document-status.processor.ts)**
