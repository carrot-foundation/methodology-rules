<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Document Type</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check if the document type is declared as organic.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/document-type.processor.ts)**
