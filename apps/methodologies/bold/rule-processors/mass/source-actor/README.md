<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Source Actor</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Ensure there is one and only one actor identified as SOURCE.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/source-actor.processor.ts)**
