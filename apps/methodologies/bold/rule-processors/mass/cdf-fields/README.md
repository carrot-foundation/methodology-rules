<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Cdf Fields</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>In an event, when there is a report identified as CDF, verify if the report number, issue date, and the value stated in the report are declared.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/cdf-fields.processor.ts)**
