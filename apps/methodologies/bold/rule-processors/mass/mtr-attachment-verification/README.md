<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Mtr Attachment Verification</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>If an MTR is declared in an event, check if the event contains a mandatory attachment.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/mtr-attachment-verification.processor.ts)**
