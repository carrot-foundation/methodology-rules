<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Has Mtr</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check in the Open event if there is an MTR for that event.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/has-mtr.processor.ts)**
