<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Numeric Weight Values</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Verify if all the values declared in a MOVE event, with the 'move type' declared as 'Weighing,' are valid numeric values.</td>
      </tr>
    </tbody>
  </table>
</div>
