<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Document Category</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check if the document category is declared as 'Mass'.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/document-category.processor.ts)**
