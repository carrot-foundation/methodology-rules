<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Document Subtype</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check if the document's subtype is allowed by the BOLD Methodology.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/document-subtype.processor.ts)**
