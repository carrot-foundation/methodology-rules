<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Weighing Fields</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check in a MOVE event, with the 'move type' declared as 'Weighing,' if it has all the mandatory weighing fields declared.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/weighing-fields.processor.ts)**
