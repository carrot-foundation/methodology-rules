<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Net Weight Verification</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Perform the function [net cargo weight = vehicle gross weight - vehicle tare] and check if the result of the function is valid based on the declared values.</td>
      </tr>
    </tbody>
  </table>
</div>
