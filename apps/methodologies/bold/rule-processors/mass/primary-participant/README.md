<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Primary Participant</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check if the participant declared as SOURCE is the same participant listed as the primary participant in the document.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/primary-participant.processor.ts)**
