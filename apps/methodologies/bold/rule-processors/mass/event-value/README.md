...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check if the declared value in the first event found with the `event-value` attribute, corresponding to the completion of the composting process, equals the value declared in the document.</td>
      </tr>
    </tbody>
  </table>
</div>
