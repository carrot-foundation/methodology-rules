<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Invoice Fields</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check, in a MOVE event, when there is metadata declared as 'invoice number,' if the mandatory invoice fields are filled.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/invoice-fields.processor.ts)**
