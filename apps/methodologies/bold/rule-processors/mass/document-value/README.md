<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Document Value</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check if the document value is greater than 0</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/document-value.processor.ts)**
