<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Cdf Attachment Name</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>If the CDF exists for the End event, check if there is an attachment named 'CDF' or 'CERTIFICADO DE DESTINAÇÃO FINAL'.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/cdf-attachment-name.processor.ts)**
