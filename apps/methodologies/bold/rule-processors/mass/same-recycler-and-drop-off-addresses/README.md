<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Same Recycler And Drop Off Addresses</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Verify if the address of the participant identified in the MOVE event with 'move type' declared as 'Drop-off' is the same as the address declared for the participant pointed as RECYCLER.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/same-recycler-and-drop-off-addresses.processor.ts)**
