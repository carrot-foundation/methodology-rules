<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Move Type</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Verify if the 'move type' metadata field is declared in all events labeled as MOVE</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/move-type.processor.ts)**
