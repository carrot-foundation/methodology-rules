<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Cdf Address</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>In an event, when there is a report identified as CDF, verify if the declared addresses for the participant identified in the event and the actor identified as Recycler are the same.</td>
      </tr>
    </tbody>
  </table>
</div>
