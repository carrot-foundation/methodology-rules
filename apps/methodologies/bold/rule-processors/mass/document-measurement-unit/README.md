<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Document Measurement Unit</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check if the unit of measurement declared in the document is KG</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/document-measurement-unit.processor.ts)**
