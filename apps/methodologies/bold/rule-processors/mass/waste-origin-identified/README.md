<div align="center">
  ...
  <h1 style="margin-bottom: -15px;">Waste Origin Identified</h1>
...
<div dir="auto">
  <table>
    ...
    <tbody>
      <tr>
        <td>Check if the mass origin identification field is declared as true or false.</td>
      </tr>
    </tbody>
  </table>
</div>
...
- **[Main Implementation File](./src/lib/waste-origin-identified.processor.ts)**
